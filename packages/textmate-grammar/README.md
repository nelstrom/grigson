...
| Section label `key` keyword (e.g. `[Verse] key: C major`)                                                                                          | `keyword.other.key-annotation.grigson`                                                                |
| Section label key-value separator (`:`)                                                                                                            | `punctuation.separator.key-value.grigson`                                                             |
| Section label key value (`C major`)                                                                                                                | `string.unquoted.grigson`                                                                             |
...
| Dot beat cell (`.`)                                                                                                                                | `punctuation.separator.beat.grigson`                                                                  |
| Chord root (`C`–`G`)                                                                                                                               | `constant.other.chord.root.grigson`                                                                   |
| Accidentals (`#`, `b`)                                                                                                                             | `constant.other.chord.accidental.grigson`                                                             |
| Chord quality (`m`, `7`, `m7b5`, `maj7`, `m7`, `dim`, `dim7`, `M7`, `7b13`, `7b9`, `7#9`, `7#5`, `7b5`, `sus4`, `sus2`, `13`, `11`, `9`, `6`, `-`) | `keyword.other.chord.quality.grigson`                                                                 |
