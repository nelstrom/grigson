...
function peg$parse(input, options) {
  ...
  const peg$c22 = 'major';
  const peg$c23 = 'minor';
  const peg$c24 = 'dorian';
  const peg$c25 = 'aeolian';
  const peg$c26 = 'mixolydian';
  const peg$c27 = 'm7b5';
  const peg$c28 = 'maj7';
  const peg$c29 = 'M7';
  const peg$c30 = 'dim7';
  ...
  const peg$e3 = peg$literalExpectation('key', false);
  ...
  const peg$e25 = peg$literalExpectation('home', false);
  const peg$e26 = peg$classExpectation([['A', 'G']], false, false, false);
  const peg$e27 = peg$classExpectation(['#', 'b'], false, false, false);
  const peg$e28 = peg$literalExpectation(' ', false);
  const peg$e29 = peg$literalExpectation('major', false);
  const peg$e30 = peg$literalExpectation('minor', false);
  const peg$e31 = peg$literalExpectation('dorian', false);
  const peg$e32 = peg$literalExpectation('aeolian', false);
  const peg$e33 = peg$literalExpectation('mixolydian', false);
  const peg$e34 = peg$literalExpectation('m7b5', false);
  const peg$e35 = peg$literalExpectation('maj7', false);
  const peg$e36 = peg$literalExpectation('M7', false);
  const peg$e37 = peg$literalExpectation('dim7', false);
  const peg$e38 = peg$literalExpectation('m7', false);
  const peg$e39 = peg$literalExpectation('dim', false);
  const peg$e40 = peg$literalExpectation('m', false);
  const peg$e41 = peg$literalExpectation('7b13', false);
  const peg$e42 = peg$literalExpectation('7b9', false);
  const peg$e43 = peg$literalExpectation('7b5', false);
  const peg$e44 = peg$literalExpectation('7#9', false);
  const peg$e45 = peg$literalExpectation('7#5', false);
  const peg$e46 = peg$literalExpectation('sus4', false);
  const peg$e47 = peg$literalExpectation('sus2', false);
  const peg$e48 = peg$literalExpectation('13', false);
  const peg$e49 = peg$literalExpectation('11', false);
  const peg$e50 = peg$literalExpectation('9', false);
  const peg$e51 = peg$literalExpectation('7', false);
  const peg$e52 = peg$literalExpectation('6', false);
  ...
  function peg$f4(fields) {
    ...
    if (meta.meter !== undefined && !isValidMeter(meta.meter)) {
      error(
        `Invalid meter: "${meta.meter}". Must be a time signature like 2/4, 4/4, 3/4, 6/8, or "mixed".`,
      );
    }
  ...
  function peg$f17(n) {
    return { kind: 'endRepeatStartRepeat', repeatCount: parseInt(n, 10) };
  }
  function peg$f18() {
    return { kind: 'endRepeatStartRepeat' };
  }
  function peg$f19(n) {
    return { kind: 'endRepeat', repeatCount: parseInt(n, 10) };
  }
  function peg$f20() {
    return { kind: 'endRepeat' };
  }
  ...
  function peg$parseCloseBarline() {
    let s0, s1, s2, s3, s4;
  ...
  function peg$parseTonalityHint() {
    let s0, s1, s2, s3, s4, s5;
  ...
  function peg$parseTonalityHintKey() {
    let s0, s1, s2, s3, s4;
...
const peg$allowedStartRules = ['Song', 'FrontMatter', 'Row', 'Bar', 'Chord'];
