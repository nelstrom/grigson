...
For CSS theming via custom properties, see [CSS custom properties](/customize/css/).
...
See [Notation presets](/customize/notation/) for the full reference and built-in presets.
