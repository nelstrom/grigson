...
const FONTS = [
  ...
  },
  {
    ...
    // All symbols rendered by the HTML renderer via GrigsonJazz typeface
    targetCodepoints: [
      0x266d,  // ♭ flat (chord accidentals)
      0x266f,  // ♯ sharp (chord accidentals)
      0x00f8,  // ø halfDiminished quality symbol
      0x25b3,  // △ maj7 quality symbol
      // Time signature digits (Math Bold U+1D7CE–1D7D7)
      0x1d7ce, 0x1d7cf, 0x1d7d0, 0x1d7d1, 0x1d7d2,
      0x1d7d3, 0x1d7d4, 0x1d7d5, 0x1d7d6, 0x1d7d7,
      // Barline glyphs
      0xe030,  // barlineSingle
      0xe031,  // barlineDouble
      0xe032,  // barlineFinal
      // Repeat barline glyphs
      0xe040,  // repeatLeft (startRepeat)
      0xe041,  // repeatRight (endRepeat)
      0xe042,  // repeatRightLeft (endRepeatStartRepeat)
      // Simile marks
      0xe500,  // repeat1Bar
      0xe501,  // repeat2Bars
    ],
  ...
  },
  {
    ...
    // All symbols the HTML renderer uses via GrigsonCursive (unicode-range:
    // U+1D7CE-1D7D7, U+E030-E033, U+E040-E042, U+E500-E501), plus the original
    ...
    targetCodepoints: [
      ...
      // Time signature digits — original Petaluma SMuFL positions (alias targets)
      0xe080, 0xe081, 0xe082, 0xe083, 0xe084,  // timeSig0–4
      0xe085, 0xe086, 0xe087, 0xe088, 0xe089,  // timeSig5–9
      // Barline glyphs (U+E030-E033 in the unicode-range)
      0xe030,  // barlineSingle
      0xe031,  // barlineDouble
      0xe032,  // barlineFinal
      0xe033,  // barlineShort
